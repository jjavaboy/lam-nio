...
* @version 1.0
*/
public class SecretShoulder {
	
	private static class SecretShoulderHolder{
		private static SecretShoulder INSTANCE = new SecretShoulder();		
	}
	
	/**
	 * No one can new an instance in the outside.
	 */
	private SecretShoulder(){}
	
	public static SecretShoulder getInstance(){
		return SecretShoulderHolder.INSTANCE;
	}
	
	private static final String DEFAULT_KEY = "WF*MG,I!'I,L~AB|TG";
    ...
    public String ecrypt(String data) throws Exception{
